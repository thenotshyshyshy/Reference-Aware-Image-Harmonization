...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataset_root',type=str, default="", help='path to iHarmony4 dataset') #mia
        ...
        parser.add_argument('--input_nc', type=int, default=3, help='# of input image channels: 4 for concated comp and mask') #mia
        ...
        parser.add_argument('--netG', type=str, default='hdnet', help='specify generator architecture [resnet_9blocks | resnet_6blocks | unet_256 | unet_128]')
        ...
        parser.add_argument('--normG', type=str, default='RAIN', help='Regional Adaptive Normalization or batch normalization [instance | batch | none]')
