...
class LocalDynamics(nn.Module):
    def __init__(self, dims_in):
        ...
        #self.self_attention = nn.MultiheadAttention(embed_dim=dims_in, num_heads=1)
        self.k = 1
    def forward(self, x, mask):
        ...
        # Self-attention on foreground features
        #attn_output, _ = self.self_attention(flattened_features_query, flattened_features_query, flattened_features_query)
        #flattened_features_query = attn_output.permute(1, 2, 0)  # (B, C, num_features)
